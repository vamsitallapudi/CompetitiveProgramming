...
public class DivideStringToGroups {
    private static void solve() throws IOException {
        DivideStringToGroups obj = new DivideStringToGroups();
        String[] ans = obj.divideString("abcdefghij", 3, 'x');
        for (String s : ans) {
    ...
    public String[] divideString(String s, int k, char fill) {
        ...
        int val = s.length() / k;
        int ansLen = s.length() % k == 0 ? val : val + 1;
